...
namespace UnityDesktopDuplication
{
    public class HDD_Manager : MonoBehaviour
    {
        ...
        /// <summary>
        /// If this variable is on, you must run both the Unity application and shremdup.exe as admin
        /// </summary>
        ...
        void InitIfNotReady()
        {
            if (!this.ready)
            {
                ...
                this.filenamePrefix = "HDD-" + System.DateTime.Now.Ticks.ToString();
                if (use_global) this.filenamePrefix = "Global\\" + this.filenamePrefix;
